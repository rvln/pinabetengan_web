<?php
// Initialize theme script specifically for login page which doesn't use the standard header/footer
// But we still want to reuse the logic if possible.
// However, the login page has a unique layout.
// We will manually include the CSS and theme logic.
?>
<!DOCTYPE html>
<html lang="id">
<head>
